							...
							int current_ma)
{
	...
	case POWER_SUPPLY_TYPE_USB:
		...
		if ((current_ma >= CURRENT_500_MA) && (current_ma < CURRENT_1000_MA)) {
			rc = smbchg_sec_masked_write(chip,
					chip->usb_chgpth_base + CHGPTH_CFG,
					CFG_USB_2_3_SEL_BIT, CFG_USB_2);
			if (rc < 0) {
		...
		if ((current_ma >= CURRENT_1000_MA) && (current_ma < CURRENT_1300_MA)) {	// AP: Fast charge for USB
			rc = smbchg_sec_masked_write(chip,
					chip->usb_chgpth_base + CHGPTH_CFG,
					CFG_USB_2_3_SEL_BIT, CFG_USB_3);
			if (rc < 0) {
			...
			rc = smbchg_masked_write(chip,
					chip->usb_chgpth_base + CMD_IL,
					USBIN_MODE_CHG_BIT | USB51_MODE_BIT,
					USBIN_LIMITED_MODE | USB51_800MA);
			if (rc < 0) {
				pr_err("Couldn't set CMD_IL rc = %d\n", rc);
				goto out;
			}
			chip->usb_max_current_ma = 1440;
		}
		if ((current_ma >= CURRENT_1300_MA) && (current_ma < CURRENT_1500_MA)) {	// AP2: Fast charge for USB
			rc = smbchg_sec_masked_write(chip,
					chip->usb_chgpth_base + CHGPTH_CFG,
					CFG_USB_2_3_SEL_BIT, CFG_USB_3);
			if (rc < 0) {
			...
			chip->usb_max_current_ma = 1240;
		}
		if ((current_ma >= CURRENT_1500_MA) && (current_ma < CURRENT_1800_MA)) {	// AP3: Fast charge for USB
			rc = smbchg_sec_masked_write(chip,
					chip->usb_chgpth_base + CHGPTH_CFG,
					CFG_USB_2_3_SEL_BIT, CFG_USB_3);
			if (rc < 0) {
			...
			chip->usb_max_current_ma = 1770;
		}
		if ((current_ma >= CURRENT_1800_MA) && (current_ma < CURRENT_2000_MA)) {	// AP4: Fast charge for USB
			rc = smbchg_sec_masked_write(chip,
					chip->usb_chgpth_base + CHGPTH_CFG,
					CFG_USB_2_3_SEL_BIT, CFG_USB_3);
			if (rc < 0) {
			...
			chip->usb_max_current_ma = 1950;
		}
		if ((current_ma >= CURRENT_2000_MA) && (current_ma <= CURRENT_2500_MA)) {	// AP5: Fast charge for USB
			rc = smbchg_sec_masked_write(chip,
					chip->usb_chgpth_base + CHGPTH_CFG,
					CFG_USB_2_3_SEL_BIT, CFG_USB_3);
			if (rc < 0) {
			...
			rc = smbchg_masked_write(chip,
					chip->usb_chgpth_base + CMD_IL,
					USBIN_MODE_CHG_BIT | USB51_MODE_BIT,
					USBIN_LIMITED_MODE | USB51_900MA);
			if (rc < 0) {
				pr_err("Couldn't set CMD_IL rc = %d\n", rc);
				goto out;
			}
			chip->usb_max_current_ma = 2400;
		}
               if ((current_ma > CURRENT_2500_MA) && (current_ma < CURRENT_3000_MA)) {      // AP6: Fast charge for USB
			rc = smbchg_sec_masked_write(chip,
					chip->usb_chgpth_base + CHGPTH_CFG,
					CFG_USB_2_3_SEL_BIT, CFG_USB_3);
			if (rc < 0) {
